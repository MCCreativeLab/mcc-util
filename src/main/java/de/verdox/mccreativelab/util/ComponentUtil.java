...
public class ComponentUtil {
    ...
    public static void install() {
        PlatformResourcePack.INSTANCE.get().getLanguageStorage().addTranslation(SECONDS);
        PlatformResourcePack.INSTANCE.get().getLanguageStorage().addTranslation(SECONDS_SHORT);
        PlatformResourcePack.INSTANCE.get().getLanguageStorage().addTranslation(MINUTES);
        PlatformResourcePack.INSTANCE.get().getLanguageStorage().addTranslation(MINUTES_SHORT);
        PlatformResourcePack.INSTANCE.get().getLanguageStorage().addTranslation(HOURS);
        PlatformResourcePack.INSTANCE.get().getLanguageStorage().addTranslation(HOURS_SHORT);
        PlatformResourcePack.INSTANCE.get().getLanguageStorage().addTranslation(DAYS);
        PlatformResourcePack.INSTANCE.get().getLanguageStorage().addTranslation(DAYS_SHORT);
    }
}
